...
<body>
            ...
            <div class="card-body">
                <table class="table table-bordered table-striped">
                    ...
                    $tampil = mysqli_query($koneksi, "
                        SELECT p.*, k.kategori AS nama_kategori 
                        FROM tb_produk p 
                        JOIN tb_kategori k ON p.kategori = k.id_kategori");
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a href="buypage.php?id=<?php echo $data['kd_skincare'] ?>"
                                    class="btn btn-outline-dark d-grid">Beli</a>
                                <a href="download_image.php?file=admin/<?= $data['image']; ?>" download
                                    class="btn btn-outline-dark btn-sm">Download Image</a>
                            </div>
                        </td>
                    </tr>
                    <?php endwhile; ?>
    ...
    <div class="container mt-5">
        <div class="row text-center row-judul">
            <h5 class="judul"><strong>Produk</strong></h5>
        </div>
    </div>
