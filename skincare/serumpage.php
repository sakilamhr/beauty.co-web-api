...
;">
    ...
    <div class="container mt-5">
        <div class="row text-center row-judul">
            <h5 class="judul"><strong>Serum</strong></h5>
        </div>
    </div>
    ...
    <div class="container mt-6">
        <div class="row">
            <?php
            $tampil = mysqli_query($koneksi, "SELECT p.*, k.kategori FROM tb_produk p JOIN tb_kategori k ON p.kategori = k.id_kategori WHERE k.id_kategori = 'k2'");
