...
;">
    ...
    <div class="container mt-5">
        <div class="row text-center row-judul">
            <h5 class="judul"><strong>Toner</strong></h5>
        </div>
    </div>
    ...
    <div class="container mt-6">
        <div class="row">
            <?php
            $tampil = mysqli_query($koneksi, "SELECT p.*, k.kategori FROM tb_produk p JOIN tb_kategori k ON p.kategori = k.id_kategori WHERE k.id_kategori = 'k1'");
                ...
                <div class="col-lg-3 col-md-2 col-sm-4 col-4 mt-3">
                    <div class="card text-center shadow-none border border-dark border-2">
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example">
                            ...
                            <a href="buypage.php?id=<?= $data['kd_skincare'] ?>"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a href="buypage.php?id=<?php echo $data['kd_skincare'] ?>"
                                    class="btn btn-outline-dark">Beli
                                    Sekarang</a>
